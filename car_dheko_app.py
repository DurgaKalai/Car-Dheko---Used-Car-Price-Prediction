...
# Header section
st.markdown("<h1>🚗 Cardheko Price Prediction</h1>", unsafe_allow_html=True)
...
# Load data
df = pd.read_csv(r"C:/Users/DURGA/Desktop/project_cardekho/unstructured datasets/final_model.csv")
...
with col2:
    ...
    if st.button("Predict Car Price"):
        ...
        with open(r"C:/Users/DURGA/Desktop/project_cardekho/unstructured datasets/pipeline.pkl", 'rb') as f:
